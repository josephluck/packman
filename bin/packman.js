...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var args, outDir, iconsDir, typesFilePath, files, spriter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    typesFilePath = path.join(cwd, args.options.out + "/icons.d.ts");
                ...
                case 1:
                    ...
                    return [4 /*yield*/, compileIconTypes(typesFilePath, files)];
                case 2:
                    _a.sent();
...
function compileIconTypes(typesFilePath, files) {
    ...
    return writeFile(typesFilePath, content)
        .then(function () { return console.log(colors.green("Icon types written to:"), colors.green(typesFilePath)); });
}
run();
